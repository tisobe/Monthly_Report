...
#
    ...
    plotPanel(xmin, xmax, yMinSets, yMaxSets, xSets, ySets, eSets, xname, yname, entLabels, 2010.0)
...
#
    ...
    entLabels = ['CCD5', 'CCD7']
    plotPanel(xmin, xmax, yMinSets, yMaxSets, xSets, ySets, eSets, xname, yname, entLabels, 2009.0)
